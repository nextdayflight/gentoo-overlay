...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/boost/boost-1.42.0-r1.ebuild,v 1.2 2010/06/17 14:39:18 jsbronder Exp $
...
src_prepare() {
	...
	if [[ -e /dev/urandom ]] ; then
		...
		cp "${FILESDIR}/${P}-random-Jamfile" libs/random/build/Jamfile.v2
	fi
}
